...
// WithRequiredRuntimeCapabilities sets the capabilities the plugin requires from the runtime.
func WithRequiredRuntimeCapabilities(required ...api.Capability) Option {
	return func(s *stub) error {
