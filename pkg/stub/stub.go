...
type PodSandboxStatusInterface interface {
	...
	PodSandboxStatus(context.Context, *api.PodSandbox, bool) (string, []string, error)
}
...
type handlers struct {
	...
	PodSandboxStatus            func(context.Context, *api.PodSandbox, bool) (string, []string, error)
...
func (stub *stub) PodSandboxStatus(ctx context.Context, req *api.PodSandboxStatusRequest) (*api.PodSandboxStatusResponse, error) {
	...
	ip, additionalIPs, err := handler(ctx, req.Pod, req.Verbose)
