...
This plugin allows testing this capability *today* using annotations, before the
official upstream K8s/CRI API is finalized and widely available.
...
only. Once the behavior is standardized in upstream Kubernetes/CRI and container
runtimes (via the mechanism proposed in KEP-5474), this plugin will be obsolete
and removed. It is not intended for long-term use.
